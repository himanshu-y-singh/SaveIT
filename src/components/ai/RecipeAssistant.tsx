      ...
      <div className="space-y-4">
        ...
        <div className="flex space-x-2">
          <input
            ...
            className="flex-1 px-3 py-2 border border-border rounded-md bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary"
